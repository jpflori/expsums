...
\hypersetup{pdftitle={A conjecture about mixed Gaussian sums and the bentness of a family of Boolean functions},%
...
The Boolean functions $f_{a,b}$ of interest are defined over $\GF{n} = \GF{m_0}$
...
The Walsh spectrum of $f_{a,b}$ at $\omega \in \GF{m_0}$ is
\begin{align*}
\Wa{f_{a,b}}(\omega) & = \sum_{x \in \GF{m_0}} \chisf{f_{a,b}(x) + \tr{m_0}{\omega x}} \\
\end{align*}
The Boolean function $f_{a,b}$ is bent if and only if
\[
\Wa{f_{a,b}}(\omega) = 2^{\pm m_1}
\]
