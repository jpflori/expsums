...
Therefore, when $\omega = 0$, the Walsh transform is
\begin{align*}
\Wa{f_{a,b}}(0) & = 1 + \left( 2^{m_1} - 1 \right) \sum_{u \in U} \addch{f_{a,b}(u)} \enspace .
\end{align*}
...
Then
\begin{align*}
\Wa{f_{a,b}}(\omega) & = 1 + \sum_{u \in U_1} \sum_{y \in \GF{m_1}^*} \addch{\tr{m_0}{a u^{2^{m_1}-1}}} \addch{\tr{2}{b u ^{\frac{2^{m_0}-1}{3}} y^{\frac{2^{m_0}-1}{3}}}} \addch{\tr{m_0}{\omega u y}} \\
& = 1 + \sum_{u \in U_1} \sum_{y \in \GF{m_1}^*} \addch{f_{a,b}(u)} \addch{\tr{m_0}{\omega u y}} \\
& = 1 + \sum_{u \in U_1} \addch{f_{a,b}(u)} \sum_{y \in \GF{m_1}^*} \addch{\tr{m_0}{\omega u y}} \\
\end{align*}

If $\omega = 0$, then
\begin{align*}
\Wa{f_{a,b}}(0) & = 1 + \left( 2^{m_1} - 1 \right) \sum_{u \in U_1} \addch{f_{a,b}(u)} \\
\end{align*}
If $\omega \neq 0$, then
\begin{align*}
\Wa{f_{a,b}}(\omega) & = 1 + \sum_{u \in U_1} \addch{f_{a,b}(u)} \left( \sum_{y \in \GF{m_1}} \addch{\tr{m_0}{\omega u y}} - 1 \right) \\
& = 1 - \sum_{u \in U_1} \addch{f_{a,b}(u)} + \sum_{u \in U_1} \addch{f_{a,b}(u)} \sum_{y \in \GF{m_1}} \addch{\tr{m_0}{\omega u y}} \\
& = 1 - \sum_{u \in U_1} \addch{f_{a,b}(u)} + \sum_{u \in U_1} \addch{f_{a,b}(u)} \sum_{y \in \GF{m_1}} \addch{\tr{m_1}{\tr[m_1]{m_0}{\omega u} y}} \\
& = 1 - \sum_{u \in U_1} \addch{f_{a,b}(u)} + 2^{m_1} \sum_{u \in U_1, \tr[m_1]{m_0}{\omega u} = 0} \addch{f_{a,b}(u)} \\
& = 1 - \sum_{u \in U_1} \addch{f_{a,b}(u)} + 2^{m_1} \addch{f_{a,b}(\omega^{\frac{2^{m_1}-1}{3}})} \\
\end{align*}

One then concludes by computing the value of
\begin{align*}
\sum_{u \in U_1} \addch{f_{a,b}(u)}
\end{align*}
...
\begin{align*}
\sum_{u \in U_1} \addch{f_{a,b}(u)} & = \sum_{u \in U_1} \addch{f_{a}(u)} \addch{\tr{2}{b u^{\frac{2^{m_0}-1}{3}}}} \\
& = \sum_{u \in U_1, b u^{\frac{2^{m_0}-1}{3}} = 1} \addch{f_{a}(u)} - \sum_{u \in U_1, b u^{\frac{2^{m_0}-1}{3}} \neq 1} \addch{f_{a}(u)} \\
& = 2 \sum_{u \in U_1, b u^{\frac{2^{m_0}-1}{3}} = 1} \addch{f_{a}(u)} - \sum_{u \in U_1} \addch{f_{a}(u)} \\
\end{align*}

The second sum is equal to
\begin{align*}
\sum_{u \in U_1} \addch{f_{a}(u)} & = 1 - K_{m_1}(a) \\
\end{align*}
...
\begin{align*}
\sum_{u \in U_1, u^{\frac{2^{m_0}-1}{3}} = 1} \addch{f_{a}(u)} & = \frac{1}{3} \sum_{u \in U_1} \addch{f_{a}(u^3)} \\
& = \frac{1}{3} \sum_{u \in U_1} \addch{\tr{m_1}{a \left( u^3 + u^{-3} \right)}} \\
& = \frac{1}{3} \sum_{u \in U_1} \addch{\tr{m_1}{a D_3(u + u^{-1})}} \\
& = \frac{1}{3} \left( 1 + \sum_{u \neq 1} \addch{\tr{m_1}{a D_3(u + u^{-1})}} \right) \\
& = \frac{1}{3} \left( 1 + 2 \sum_{t \in \T_1} \addch{\tr{m_1}{a D_3(t)}} \right) \\
& = \frac{1}{3} \left( 1 + 2 \sum_{t \in \GF{m_1}} \addch{\tr{m_1}{a D_3(t)}} - 2 \sum_{t \in \T_0} \addch{\tr{m_1}{a D_3(t)}} \right) \\
& = \frac{1}{3} \left( 1 + 2 \sum_{t \in \GF{m_1}} \addch{\tr{m_1}{a D_3(t)}} - 2 \sum_{t \in \T_0} \addch{\tr{m_1}{a t}} \right) \\
...
\begin{align*}
\Wa{f_{a,b}}(0) & = 1 + \sum_{u \in U_1} \addch{\tr{m_0}{a u^{2^{m_1}-1}}} \sum_{y \in \GF{m_1}^*}  \addch{\tr{2}{b y^{(2^{m_1}+1) \frac{2^{m_1}-1}{3}}}} \\
& = 1 + \frac{2^{m_1} - 1}{3} \left( 1 - K_{m_1}(a) \right) \sum_{c \in \GF[4]{}^*} \addch{\tr{2}{b c}} \\
